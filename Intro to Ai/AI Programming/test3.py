...
#Check if duplicates are present in already given puzzle    
...
def is_valid_assignment_BT(row, col, num):
    """
...
def solve_sudoku_BT():
    ...
    for num in range(1, 10):
        if is_valid_assignment_BT(row, col, str(num)):
...
with open('testcase1.csv', 'r') as file:
